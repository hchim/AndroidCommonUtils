...
import com.sleepaiden.androidcommonutils.NetworkUtils;
...
public class MetricHelper {
    ...
    public MetricHelper(Context context, AppConfig appConfig) {
        this.context = context;
        metricServiceClient = new MetricServiceClient(appConfig);
